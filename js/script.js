...
// PROMPTING USER
var userInput = window.prompt("Enter winning score: ");
...
function drawProgressBarRed() {
	...
	colorRect(100, 550, player1Score*(200/WINNING_SCORE), 20, "red");
}
...
function drawProgressBarBlue() {
	...
	colorRect(700, 550, -player2Score*(200/WINNING_SCORE), 20, "blue");
}
